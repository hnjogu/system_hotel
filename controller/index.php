...
<html lang="en">
<head>
<title>SUNRISE HOTEL Management system</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+254 (your number)</li>	
					<li class="s-bar">
						<div class="search">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="admin/index.php">Staff_login/Admin</a></li>
						</ul>
					</nav>
				</div>
			</nav>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2>Click Here For ROOM RESERVATION</h2></a>
</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+94 (your number)</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Nairobi, kaunda street</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.81543126185!2d36.82155401475401!3d-1.2846848990629924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f10d655bea10d%3A0x8eee1c4474205126!2sKaunda+St%2C+Nairobi!5e0!3m2!1sen!2ske!4v1549702379549"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
					            ...
					            <div class="row">
					                <div class="col-lg-12">
					                    <div class="footer_copyright">
					                        <p> Welcome To SunRise Hotel Management System &copy;
					                            <script>
